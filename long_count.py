...
def show_welcome_message():
    ...
    lord_of_the_night_today = calculate_lord_of_the_night(jdn_today)  # Calculate today's Lord of the Night

    print(f"Today's Long Count is {'.'.join(map(str, long_count_today))}.")
    print(f"Today's Haab' is {haab_day_today} {haab_month_today}.")
    print(f"Today's Tzolk'in is {tzolkin_number_today} {tzolkin_name_today}.")
    print(f"Today's Lord of the Night: {lord_of_the_night_today}")  # Print today's Lord of the Night
    ...
    while True:
        try:
            ...
            if validate_date(year, month, day):
                ...
                print(f"Lord of the Night: {lord_of_the_night}")  # Displaying the Lord of the Night
            else:
